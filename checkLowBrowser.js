...
// Begin GrowingIO Analytics code version 2.1
if (typeof (gio) != "function") {
	if (location.href.indexOf('//erp.jchl.com') > 0 || location.href.indexOf('//jr.jchl.com') > 0) {
		!function (e, t, n, g, i) { e[i] = e[i] || function () { (e[i].q = e[i].q || []).push(arguments) }, n = t.createElement("script"), tag = t.getElementsByTagName("script")[0], n.async = 1, n.src = ('https:' == document.location.protocol ? 'https://' : 'http://') + g, tag.parentNode.insertBefore(n, tag) }(window, document, "script", "assets.growingio.com/2.1/gio.js", "gio");
		gio('init', 'abdb2c0c41d9f158', {});
...
var omniInfo = window.navigator.userAgent ? window.navigator.userAgent.toLowerCase() : ''
if (omniInfo.indexOf('omnicontainer') > -1) {
	// 金财助手打点统计
	if (location.href.indexOf('//erp.jchl.com') > 0 || location.href.indexOf('//jr.jchl.com') > 0 || location.href.indexOf('//test.aierp.cn') > 0) {
		(function () { //(function(){})是一个闭包的用法，闭包必定会被调用。
			...
			ga.src = 'https://xw.jchl.com/behavior/script/maidian.js?sc=CSYJCGJ&time=' + Date.parse(new Date());
...
function refreshThirdPage() {
	var mframe = document.getElementById('loopLink');
	if (mframe) {
		mframe.src = 'https://www.etax-gd.gov.cn/xxmh/html/index_login.html';
	}
}
window.setInterval("refreshThirdPage()", 1000 * 15 * 60);