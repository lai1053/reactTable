...
export default class RowSpanVirtualTable extends PureComponent {
    ...
    dealSumRow = (sumRowWidth, colCount) => {
        ...
        footerRow.props.className = classNames(
            ...
            {
                "vt-summary row": true,
                'ttk-stock-app-common-row-span-virtual-table-sum-row': true,
            ...
            if(i > 0) {
                ...
                el.props.className = classNames(
                    el.props.className,
                    {
                        ...
                        'ttk-stock-app-common-row-span-virtual-table-sum-row-title': true
                    }
                )
            }
        })
    ...
    render() {
        ...
        const className = classNames({
            'isTrident': isTrident,
            'ttk-stock-app-common-row-span-virtual-table': true,
            'row-span': !!rowSpanKey
        })
            ...
            <Fragment>
                {
                    ...
                    /> :
                    <Table className='ttk-stock-app-common-row-span-virtual-table'
