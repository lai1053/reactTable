...
export default {
    operation: {
        ...
        export: option => fetch.formPost("/v1/biz/bovms/stock/bill/title/exportSaleIncome", option), //导出
        templateExport: option =>
            fetch.formPost("/v1/biz/bovms/stock/importAndExport/downloadXssrTemplate", option), //导出
        uploadFile: option =>
            fetch.post("/v1/biz/bovms/stock/importAndExport/uploadXssrFile", option), // 导入数据
