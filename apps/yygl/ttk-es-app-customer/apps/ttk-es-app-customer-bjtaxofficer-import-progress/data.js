export function getMeta() {
    return {
        name: 'root',
        component: 'Layout',
        className: 'ttk-es-app-customer-bjtaxofficer-import-progress',
        children:[
            {
                name:'progress',
                component:'::div',
                        ...
                        children:[
                            {
                                ...
                                children:'{{data.downloads[_rowIndex].gsmc+"，导入失败："}}'
                            },
                            {
                                name: 'popover',
                                component: 'Popover',
                                popupClassName: 'ttk-es-app-customer-import-progress-popover',
                                placement: 'bottom',
                                title: '',
                                content: {
