...
export default {
    ...
    user: {
        ...
        getUserDetail: () => fetch.post('v1/yygl/person/getUserDetail')
    },
    org: {
    ...
    orderCenter:{
        getConsume: (option) => fetch.post('/v1/edf/ordercenter/queryConsumeManager'),
        getInfo: (option) => fetch.post('/v1/edf/ordercenter/queryCusAccountInfo'),
    }
}
