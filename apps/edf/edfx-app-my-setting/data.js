export function getMeta() {
	return {
		name: 'root',
		component: '::div',
		className: 'edfx-app-my-setting',
		children: {
			name: 'content',
			component: '::div',
			className: 'edfx-app-my-setting-content',
			children: {
				name: 'item',
				component: '::div',
				className: 'container',
				children: [{
					name: 'baseInfo',
					component: '::div',
					className: 'edfx-app-my-setting-baseInfo',
					children: [{
						name: 'title',
						component: '::h1',
						className: 'edfx-app-my-setting-baseInfo-title',
						children: '个人基础信息'
					}, {
						name: 'form',
						component: 'Form',
						className: 'edfx-app-my-setting-baseInfo-form',
						children: [{
							name: 'photoItem',
							component: 'Form.Item',
							className: 'edfx-app-my-setting-baseInfo-form-photo',
							required: true,
							children: [{
								name: 'container',
								component: '::div',
							...
							name: 'detailItem',
							component: '::div',
							className: 'edfx-app-my-setting-baseInfo-form-detail',
							children: [{
								name: 'sexItem',
								component: 'Form.Item',
								className: 'edfx-app-my-setting-baseInfo-form-detail-sex',
								label: '头像',
								required: true,
								children: [{
									name: 'male',
							...
							name: 'saveItem',
							component: 'Form.Item',
							className: 'edfx-app-my-setting-baseInfo-form-saveBtn',
							children: [{
								name: 'save',
								component: 'Button',
								type: 'primary',
					...
					className: 'edfx-app-my-setting-security',
					children: [{
						name: 'title',
						component: '::h1',
						className: 'edfx-app-my-setting-baseInfo-title',
						...
						name: 'item',
						component: '::div',
						className: 'edfx-app-my-setting-security-box',
						children: [
						// 	{
						// 	name: 'level',
						// 	component: '::div',
						...
						// }, 
							...
							name: 'grid',
							component: '::div',
							className: 'edfx-app-my-setting-security-grid',
							className: 'edfx-app-my-setting-security-layout',
							children: [{
								name: 'password',
								className: 'edfx-app-my-setting-security-grid-row',
								component: '::div',
								key: 'password',
