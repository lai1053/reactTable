...
class action {
    ...
    checkNext = () => {
        ...
        if(step == 1) {
            return !((data.form.mobile && !data.other.error.mobile) && (data.form.captcha && !data.other.error.captcha)&&(data.form.password && !data.other.error.password) && (data.form.confirmPassword && !data.other.error.confirmPassword))
        }else if(step == 2) {
