...
export default {
    user: {
        login: (option) => fetch.post('/v1/edf/user/login', option),
        create: (option) => fetch.post('/v1/edf/dzgl/createUser', option),
        createOrg: (option) => fetch.post('/v1/edf/dzgl/register', option),
        existsMobileForLogin: (mobile) => fetch.post('/v1/edf/user/existsMobile', {mobile}),
        existsMobile: (mobile) => fetch.post('/v1/edf/user/existsMobileForRegister', {mobile}),
    ...
    dzgl: {
        login: (option) => fetch.post('/v1/edf/dzgl/IsSuccessloginUc', option),
    }
}
