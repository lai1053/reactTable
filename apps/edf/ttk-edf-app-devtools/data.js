	...
	return {
		...
		children: [{
			...
			children: [{
				...
				name: 'html2json',
				_visible: "{{data.tabKey=='html2json'}}",
				component: `{{$isExistsApp('ttk-edf-app-html2json')?'AppLoader':'::div'}}`,
				notRender: "{{data.tabKey!='html2json'}}",
				appName: 'ttk-edf-app-html2json',
				children: '运行网站需要ttk-edf-app-html2json应用，可以使用[ttk clone ttk-edf-app-html2json apps/]克隆应用',
				_excludeProps: "{{$isExistsApp('ttk-edf-app-html2json')?['_visible','children']:['notRender','appName']}}"
