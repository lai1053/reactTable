...
class action {
    ...
    load = async (kjxh) => {
        ...
        if (kjxh) {
            ...
            let initInfo = await this.webapi.invoices.initiateAddOfXxfp({ qyId, nsrsbh,fpzlDm:'09',skssq:this.component.props.nsqj })
            if (initInfo) {
                initData = {
                    details: [{}, {}, {}, {}],
                    xfmc: initInfo.xfmc,
        ...
        switch (jsfs) {
            ...
            case undefined:
                ...
                if (nsrxz == 'YBNSRZZS') {
                    ...
                    slListNew = slList.filter(f =>f.slv >= 0 ||  f.slv == 0.05 || f.slv == 0.03 || f.slv == 0.01)
                }
                break
        }
