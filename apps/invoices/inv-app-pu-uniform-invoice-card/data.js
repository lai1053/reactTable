export function getMeta() {
    return {
        name: 'root',
        component: 'Layout',
        className: 'inv-app-pu-uniform-invoice-card',
        id: 'inv-app-pu-uniform-invoice-card',
        ...
        children: [{
            ...
            children: [{
                    name: 'head',
                    component: '::div',
                    className: 'inv-app-pu-uniform-invoice-card-header',
                    children: [{
                            name: 'title',
                            component: '::div',
                            className: 'inv-app-pu-uniform-invoice-card-header-title',
                            children: '农产品销售（收购）发票'
                        },
                        {
                            name: 'form',
                            component: '::div',
                            className: 'inv-app-pu-uniform-invoice-card-header-form',
                            children: [{
                                    name: 'item1',
                                    component: '::div',
                                    className: 'inv-app-pu-uniform-invoice-card-header-form-item',
                                    children: [{
                                            name: 'label',
                                            component: '::div',
                                            className: '{{$isReadOnly()?"inv-app-pu-uniform-invoice-card-header-form-item-label ":"inv-app-pu-uniform-invoice-card-header-form-item-label ant-form-item-required"}}',
                                            children: {
                                                name: 'tooltip',
                                                component: 'Tooltip',
                                                placement: 'left',
                                        ...
                                        },
                                        {
                                            ...
                                            className: '{{data.error.fpdm?"inv-app-pu-uniform-invoice-card-header-form-item-value has-error":"inv-app-pu-uniform-invoice-card-header-form-item-value"}}',
                                ...
                                },
                                {
                                    ...
                                    children: [{
                                        ...
                                        },
                                        {
                                            ...
                                            disabled: '{{$notAllowEdit()}}',
                                            maxLength: 8,
                                            className: '{{data.error.fphm?"inv-app-pu-uniform-invoice-card-header-form-item-value has-error":"inv-app-pu-uniform-invoice-card-header-form-item-value"}}',
                                ...
                                },
                                {
                                    ...
                                    children: [{
                                        ...
                                        },
                                        {
                                            ...
                                            disabled: '{{$notAllowEdit()}}',
                                            placeholder: '',
                                            className: '{{data.error.kprq?"inv-app-pu-uniform-invoice-card-header-form-item-value has-error":"inv-app-pu-uniform-invoice-card-header-form-item-value"}}',
                ...
                {
                    name: 'inv-app-pu-uniform-invoice-card-grid1',
                    className: 'inv-app-pu-uniform-invoice-card-grid1',
                    component: '::div',
                    children: [{
                        name: 'row',
                        component: 'Row',
                ...
                },
                {
                    name: 'mxDetailList',
                    component: 'DataGrid',
                    className: 'inv-app-pu-uniform-invoice-card-form-details',
                    headerHeight: 24,
                    rowHeight: 24,
                ...
                {
                    name: 'inv-app-pu-uniform-invoice-card-heji1',
                    className: 'inv-app-pu-uniform-invoice-card-heji1',
                    component: '::div',
                    children: [{
                            name: 'col1',
                            component: '::div',
                ...
                {
                    name: 'inv-app-pu-uniform-invoice-card-heji2',
                    className: 'inv-app-pu-uniform-invoice-card-heji2',
                    component: '::div',
                    children: [{
                            name: 'col1',
                            component: '::div',
                ...
                {
                    name: 'inv-app-pu-uniform-invoice-card-grid2',
                    component: '::div',
                    className: 'inv-app-pu-uniform-invoice-card-grid2',
                    children: [{
                            name: 'row',
                            component: 'Row',
                            className: 'grid-row',
                        ...
                        },
                        {
                            ...
                            children: [{
                                    ...
                                    children: {
                                        ...
                                        children: {
                                            ...
                                            children: {
                                                ...
                                                align: 'left',
                                                placeholder: '',
                                                value: '{{$isReadOnly()? data.form.showBdlyLx:data.form.bdlyLx}}',
                                ...
                                },
                                {
                                    name: 'row2-col3',
                                    component: 'Col',
                                    className: "{{$isV2Component()?'invoice-card-grid-thead':'invoice-card-grid-thead left-border'}}",
                                    span: '{{$isV2Component()?3:13}}',
                                    children: {
                                        name: 'row2-col1-div',
                                        component: '::div',
                                        className: '{{data.form.bdzt && data.form.bdlyLx==1 && data.form.fplyLx==2?"ant-form-item-required":""}}',
                                        children: '抵扣月份'
                                    }
                                },
                                {
                    ...
                    children: [{
                        ...
                        //defaultVisible:'{{data.justShow && !data.form.gfHcfpdm ? true : false}}',
