...
class action {
    ...
    onInit = ({ component, injections }) => {
        ...
        history.listen('inv-app-root', this.listen)
        this.onRedirect({ appName: history.getChildApp('inv-app-root') || defaultAppName })
    }
    ...
    onRedirect = ({ appName }) => {
        history.pushChildApp('inv-app-root', appName)
    }

    componentWillUnmount = () => {
        history.unlisten('inv-app-root', this.listen)
    }
}
