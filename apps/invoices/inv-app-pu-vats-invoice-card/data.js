...
export function getMeta() {
    return {
        name: 'root',
        component: 'Layout',
        className: 'inv-app-pu-vats-invoice-card',
        id: 'inv-app-pu-vats-invoice-card',
        ...
        children: [{
                ...
                children: [{
                        name: 'head',
                        component: '::div',
                        className: 'inv-app-pu-vats-invoice-card-header',
                        children: [{
                                name: 'title',
                                component: '::div',
                                className: 'inv-app-pu-vats-invoice-card-header-title',
                                children: '增值税专用发票'
                            },
                            {
                                name: 'form1',
                                component: '::div',
                                className: 'inv-app-pu-vats-invoice-card-header-form',
                                children: [{
                                        name: 'item1',
                                        component: '::div',
                                        className: 'inv-app-pu-vats-invoice-card-header-form-item',
                                        children: [{
                                                name: 'label',
                                                component: '::div',
                                                className: '{{$isReadOnly()?"inv-app-pu-vats-invoice-card-header-form-item-label ":"inv-app-pu-vats-invoice-card-header-form-item-label ant-form-item-required"}}',
                                                children: {
                                                    name: 'tooltip',
                                                    component: 'Tooltip',
                                                    placement: 'left',
                            ...
                            },
                            {
                                name: 'form2',
                                component: '::div',
                                className: 'inv-app-pu-vats-invoice-card-header-form form2',
                                children: [{
                                    name: 'item1',
                                    component: '::div',
                                    className: 'inv-app-pu-vats-invoice-card-header-form-item',
                                    children: [{
                                            name: 'label',
                                            component: '::div',
                                            className: 'inv-app-pu-vats-invoice-card-header-form-item-label',
                                            children: '机器编号：'
                                        },
                                        {
                                            name: 'value',
                                            ...
                                            className: 'inv-app-pu-vats-invoice-card-header-form-item-value',
                    ...
                    {
                        name: 'inv-app-pu-vats-invoice-card-grid1',
                        className: 'inv-app-pu-vats-invoice-card-grid1',
                        component: '::div',
                        children: [{
                            name: 'row',
                            component: 'Row',
                    ...
                    },
                    {
                        name: 'mxDetailList',
                        component: 'DataGrid',
                        className: 'inv-app-pu-vats-invoice-card-form-details',
                        headerHeight: 24,
                        rowHeight: 24,
                    ...
                    {
                        name: 'inv-app-pu-vats-invoice-card-heji1',
                        className: 'inv-app-pu-vats-invoice-card-heji1',
                        component: '::div',
                        children: [{
                                name: 'col1',
                                component: '::div',
                    ...
                    {
                        name: 'inv-app-pu-vats-invoice-card-heji2',
                        className: 'inv-app-pu-vats-invoice-card-heji2',
                        component: '::div',
                        children: [{
                                name: 'col1',
                                component: '::div',
                    ...
                    {
                        name: 'inv-app-pu-vats-invoice-card-grid2',
                        component: '::div',
                        className: 'inv-app-pu-vats-invoice-card-grid2',
                        children: [{
                                name: 'row',
                                component: 'Row',
                                className: 'grid-row',
                                        ...
                                        children: {
                                            ...
                                            children: {
                                                ...
                                                children: {
                                                    name: 'status',
                                                    component: '{{$isReadOnly()?"DataGrid.TextCell":"Select"}}',
                                                    //component: '{{$isReadOnly()?"::span":"Select"}}',
                                                    align: 'left',
                                                    placeholder: '',
                                                    value: '{{ data.justShow === true ? data.form.showBdlyLx : data.form.bdlyLx}}',
            ...
            //     name: 'footer',
            //     component: '::div',
            //     className: 'inv-app-pu-vats-invoice-card-footer',
            //     children: {
            //         name: 'btn',
            //         component: 'Button',
            //         type: 'primary',
