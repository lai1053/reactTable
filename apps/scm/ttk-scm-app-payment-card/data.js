...
export function getMeta() {
	return {
		name: 'root',
		component: 'Layout',
		className: 'ttk-scm-app-payment-card',
		id: 'ttk-scm-app-payment-card',
		onMouseDown: '{{$mousedown}}',
		children: [{
				name: 'audited',
				component: '::img',
				className: 'ttk-scm-app-payment-card-audit-tag',
				src: './vendor/img/scm/audited.png',
				_visible: '{{data.form.status == data.consts.VOUCHERSTATUS_Approved}}'
			}, {
			name: 'header',
			component: 'Layout',
			className: 'ttk-scm-app-payment-card-header',
			children: [{
				name: 'left',
				component: 'Layout',
				className: 'ttk-scm-app-payment-card-header-left',
				children: [{
					name: 'page',
				...
				name: 'right',
				component: 'Layout',
				className: 'ttk-scm-app-payment-card-header-right',
				children: [{
					name: 'shortcut',
					component: '::span',
					...
					overlay: {
						...
						children: [{
							...
							component: 'Menu.Item',
							key: 'del',
							disabled: '{{data.other.pageStatus === data.consts.pageStatus.READ_ONLY || data.other.pageStatus === data.consts.pageStatus.ADD || data.other.sourceVoucherTypeId == data.consts.VOUCHERTYPE_Delivery || data.other.sourceVoucherTypeId == "1000030013"}}',
							children: '删除'
						}/*, {
							name: 'pay',
							component: 'Menu.Item',
			...
			name: 'content',
			component: '::div',
			className: 'ttk-scm-app-payment-card-content',
			children: [{
				name: 'title',
				component: 'Layout',
				className: 'ttk-scm-app-payment-card-title',
				children: [{
					name: 'left',
					component: 'Layout',
					className: 'ttk-scm-app-payment-card-title-left',
					children: [{
						name: 'docCode',
						component: '::div',
						_visible: '{{data.form.status == data.consts.VOUCHERSTATUS_Approved}}',
					...
					name: 'center',
					component: '::div',
					className: 'ttk-scm-app-payment-card-title-center',
					children: {
						name: 'title',
						component: '::h1',
					...
					name: 'right',
					component: 'Layout',
					className: 'ttk-scm-app-payment-card-title-right',
					children: [{
						name: 'title',
						component: '::span',
				...
				name: 'formHeader',
				component: 'Form',
				className: 'ttk-scm-app-payment-card-form-header',
				children: '{{$renderFormContent()}}'
			}, {
				name: 'details',
				component: 'DataGrid',
				ellipsis: true,
				className: 'ttk-scm-app-payment-card-form-details',
				headerHeight: 35,
				rowHeight: 35,
				footerHeight: 35,
				...
				columns: [{
					...
					cell: {
						...
						allowClear: false,
						popupClassName: "ttk-scm-app-payment-card-Cascader",
						tip: true,
					...
					cell: {
						...
						onChange: '{{$onFieldChange({ id: "ata.form.details."+_rowIndex+".deptPersonId",' +
				...
				name: 'footer',
				component: '::div',
				className: 'ttk-scm-app-payment-card-footer',
				children: {
					name: 'container',
					component: '::div',
					children: [{
						name: 'left',
						component: 'Layout',
						className: 'ttk-scm-app-payment-card-footer-left',
						children: {
							name: 'container',
							component: '::div',
							children: [{
						...
						name: 'right',
						component: 'Layout',
						className: 'ttk-scm-app-payment-card-footer-right',
						children: [{
							name: 'saveAndNew',
							component: 'Button',
							type: 'primary',
	...
	return {
		data: {
			...
			consts: {
				...
				VOUCHERTYPE_Delivery: consts.consts.VOUCHERTYPE_Arrival //来源为采购单
			}
		}
	};
}
