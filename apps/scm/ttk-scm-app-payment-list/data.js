...
export function getMeta() {
	return {
		name: 'root',
		component: 'Layout',
		className: 'ttk-scm-app-payment-list',
		children: [{
			name: 'tablesetting',
			component: 'TableSettingCard',
			data: '{{data.other.columnDetails}}',
			showTitle: '{{true}}',
			positionClass: 'ttk-scm-app-payment-list-Body',
			...
			name: 'accountQuery',
			title: 'accountQuery',
			className: 'ttk-scm-app-payment-list-accountQuery',
			...
			menuBtn: [
				{
					...
					children: {
						name: 'internal',
						component: 'Button',
						className:'ttk-scm-app-payment-list-more',
						children: [{
							name: 'more',
							component: 'Icon',
							type: 'down'
				...
				}, 
				{
					...
					component: 'Icon',
					fontFamily: 'edficon',
					className: 'ttk-scm-app-payment-list-dayin',
					type: 'dayin',
					onClick: '{{$print}}',
					title: '打印'
				}*/, {
					...
					component: 'Icon',
					fontFamily: 'edficon',
					className: 'ttk-scm-app-payment-list-daochu',
					type: 'daochu',
					title: '导出',
					onClick: '{{$export}}'
				}],
			...
			className: 'ttk-scm-app-payment-list-Body',
			name: 'report',
			component: 'Table',
			key: '{{data.tableKey}}',
			checkboxKey: 'code',
			remberName: 'ttk-scm-app-payment-list',
			...
			name: 'footer',
			className: 'ttk-scm-app-payment-list-footer',
			component: '::div',
			children: [{
				name: 'pagination',
