...
export function getMeta() {
	return {
		name: 'root',
		component: 'Layout',
		className: 'ttk-scm-app-add-tax',
		children: [
			{
				name: 'header',
				component: '::div',
				className: "{{data.isFromOneself?'ttk-scm-app-add-tax-header height45':'ttk-scm-app-add-tax-header'}}",
				style: { height: '45px', lineHeight: '44px' },
				children: [{
					name: 'left',
					component: '::div',
					className: 'ttk-scm-app-add-tax-header-left',
					children: [{
						name: 'date',
						component: '::span',
						className: 'date-span',
						_visible: "{{!data.isFromOneself}}",					
						children: '{{"按月数据：（" + data.sksq + "-" + data.sksz + "）"}}'
					},{
						name: 'dateControl',
						component: '::span',
						className: 'date-span',
					...
					name: 'right',
					component: '::div',
					className: 'ttk-scm-app-add-tax-header-right',
					_visible: "{{!data.isFromOneself}}",
					onClick: '{{$downloadText}}',
					children: [{
						name: 'btn',
					...
					name: 'export',
					component: '::div',
					className: 'ttk-scm-app-add-tax-header-export',
					_visible: "{{data.isFromOneself}}",	
					children: [{
						name: 'daochu',
						component: 'Icon',
			...
			},
			{
				name: 'content',
				component: 'Layout',
				className: 'ttk-scm-app-add-tax-content',
				children: [{
					name: 'dataGrid',
					component: 'DataGrid',
