...
class reducer {
	...
	load = (state, data ) => {
		let len = data.zzsSbListByMonth.length
		...
		data.zzsSbListByMonth = data.zzsSbListByMonth.map( (item , index) => {
			item.seq = index+1
		...
		data.zzsSbListByMonth.push({//hjByMonth
			seq: '合计',
			"ssyf": " ",
			"ynse": number.format((data.hjByMonth.ynsehj? data.hjByMonth.ynsehj-0 : 0), 2),
			"bqyjse": number.format((data.hjByMonth.bqyjsehj? data.hjByMonth.bqyjsehj-0 : 0), 2),
			"zyxsesfl": ' ',
			"zxsesfl": ' ',
			"asysljsxse": number.format((data.hjByMonth.asysljsxsehj? data.hjByMonth.asysljsxsehj-0 : 0), 2),
			"ajybfjsxse": number.format((data.hjByMonth.ajybfjsxsehj? data.hjByMonth.ajybfjsxsehj-0 : 0), 2),
			"mdtbfckxse": number.format((data.hjByMonth.mdtbfckxsehj? data.hjByMonth.mdtbfckxsehj-0 : 0), 2),
			"msxse": number.format((data.hjByMonth.msxsehj? data.hjByMonth.msxsehj-0 : 0), 2),
			"xxse": number.format((data.hjByMonth.xxsehj? data.hjByMonth.xxsehj-0 : 0), 2),
			"jxse": number.format((data.hjByMonth.jxsehj? data.hjByMonth.jxsehj-0 : 0), 2),
			"sqldse": number.format((data.hjByMonth.sqldsehj? data.hjByMonth.sqldsehj-0 : 0), 2),
			"jxsezc": number.format((data.hjByMonth.jxsezchj? data.hjByMonth.jxsezchj-0 : 0), 2),
			"mdtytse": number.format((data.hjByMonth.mdtytsehj? data.hjByMonth.mdtytsehj-0 : 0), 2),
			"qmldse": number.format((data.hjByMonth.qmldsehj? data.hjByMonth.qmldsehj-0 : 0), 2),
			"jybfYnse": number.format((data.hjByMonth.jybfYnsehj? data.hjByMonth.jybfYnsehj-0 : 0), 2),
		})
		state = this.metaReducer.sf(state, `data.list`, fromJS(data.zzsSbListByMonth))
