...
class reducer {
    ...
    init = (state, option) => {//初始化
        ...
        initState.data.accountingStandards = option.initData.accountingStandards
        initState.data.type = option.initData.type
        initState.data.period = option.initData.period
        initState.data.index = option.initData.index
        ...
        if(initState.data.type==1) {
            ...
            // if (option.initData.accountingStandards == consts.ACCOUNTINGSTANDARDS_nonProfitOrganization) {
