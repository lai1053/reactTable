        ...
        return (
            <div>
                ...
                <div className="btnContainer" style={{ PaddingRight: '10px' }}>
                    <Button className="btndisabled" disabled={!hasSaleCostCarryForwardDoc ? false : true} style={{ marginRight: '8px', fontSize: '12px', padding: '0px 15px' }} type='primary' onClick={this.confirm}>保存</Button>
