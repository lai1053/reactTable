...
export default {
	taxFormula: {
		...
		query: (option) => fetch.post('/v1/gl/supertaxExpression/query', option),
		querygetAccountList: () => fetch.post('/v1/gl/supertaxExpression/getAccountList'),//获取科目集合
		save: (option) => fetch.post('/v1/gl/supertaxExpression/save', option),
		reset: (option) => fetch.post('/v1/gl/supertaxExpression/reset', option),
		getSupertaxExpressionItem: (option) => fetch.post('/v1/gl/supertaxExpression/getSupertaxExpressionItem', option)//
	}
}