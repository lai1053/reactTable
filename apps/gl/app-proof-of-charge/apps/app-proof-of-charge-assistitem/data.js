export function getMeta() {
		return {
				name: 'root',
				component: 'Form',
				className: 'app-proof-of-charge-assistitem',
				children: [{
						name: 'customer',
						component: 'Form.Item',
						label: '客户',
						...
						children: [{
							...
							name: 'linkTo',
							component: '::a',
							className: 'app-proof-of-charge-assistitem-openContent',
							onClick: '{{function(){$openContent("customer", "客户")}}}',
							href: 'javaScript:;',
							children: '编辑'
						}]
				}, {
						...
						children: [{
							...
							component: '::a',
							className: 'app-proof-of-charge-assistitem-openContent',
							onClick: '{{function(){$openContent("supplier","供应商")}}}',
							href: 'javaScript:;',
							children: '编辑'
						}]
				}, {
						...
						children: [{
							...
							component: '::a',
							className: 'app-proof-of-charge-assistitem-openContent',
							onClick: '{{function(){$openContent("project", "项目")}}}',
							href: 'javaScript:;',
							children: '编辑'
						}]
				}, {
						...
						children: [{
							...
							component: '::a',
							className: 'app-proof-of-charge-assistitem-openContent',
							onClick: '{{function(){$openContent("department", "部门")}}}',
							href: 'javaScript:;',
							children: '编辑'
						}]
				}, {
						...
						children: [{
							...
							children: '：'
								...
								dropdownFooter: {
										...
										style: { width: '100%', borderRadius: '0' },
										children: '新增',
										onClick: "{{function(){$addArchive('person')}}}"
								},
						},{
							name: 'linkTo',
							component: '::a',
							className: 'app-proof-of-charge-assistitem-openContent',
							onClick: '{{function(){$openContent("person", "人员")}}}',
							href: 'javaScript:;',
							children: '编辑'
						}]
				}, {
						...
						children: [{
							...
							children: '：'
								...
								dropdownFooter: {
										...
										style: { width: '100%', borderRadius: '0' },
										children: '新增',
										onClick: "{{function(){$addArchive('inventory')}}}"
								},
						},{
							name: 'linkTo',
							component: '::a',
							className: 'app-proof-of-charge-assistitem-openContent',
							onClick: '{{function(){$openContent("inventory","存货")}}}',
							href: 'javaScript:;',
							children: '编辑'
						}]
				}, {
						...
						children: [{
								...
								dropdownFooter: {
										...
										style: { width: '100%', borderRadius: '0' },
										children: '新增',
										onClick: "{{function(){$addArchive(data.form.accountingSubject.calcDict.isExCalc1, 'exCalc1')}}}"
								},
						},{
							name: 'linkTo',
							component: '::a',
							className: 'app-proof-of-charge-assistitem-openContent',
							onClick: '{{function(){$openContent("userdefinecard", data.form.accountingSubject.calcDict.isExCalc1)}}}',
							href: 'javaScript:;',
							children: '编辑'
						}]
				}, {
						...
						children: [{
							...
							children: '：'
								...
								dropdownFooter: {
										...
										style: { width: '100%', borderRadius: '0' },
										children: '新增',
										onClick: "{{function(){$addArchive(data.form.accountingSubject.calcDict.isExCalc2, 'exCalc2')}}}"
								},
						},{
							name: 'linkTo',
							component: '::a',
							className: 'app-proof-of-charge-assistitem-openContent',
							onClick: '{{function(){$openContent("userdefinecard", data.form.accountingSubject.calcDict.isExCalc2)}}}',
							href: 'javaScript:;',
							children: '编辑'
						}]
				}, {
						...
						children: [{
							...
							children: '：'
								...
								dropdownFooter: {
										...
										style: { width: '100%', borderRadius: '0' },
										children: '新增',
										onClick: "{{function(){$addArchive(data.form.accountingSubject.calcDict.isExCalc3,'exCalc3')}}}"
								},
						},{
							name: 'linkTo',
							component: '::a',
							className: 'app-proof-of-charge-assistitem-openContent',
							onClick: '{{function(){$openContent("userdefinecard", data.form.accountingSubject.calcDict.isExCalc3)}}}',
							href: 'javaScript:;',
							children: '编辑'
						}]
				},{
						...
						children: [{
							...
							children: '：'
								...
								dropdownFooter: {
										...
										style: { width: '100%', borderRadius: '0' },
										children: '新增',
										onClick: "{{function() {$addArchive(data.form.accountingSubject.calcDict.isExCalc4,'exCalc4')}}}"
								},
						},{
							name: 'linkTo',
							component: '::a',
							className: 'app-proof-of-charge-assistitem-openContent',
							onClick: '{{function(){$openContent("userdefinecard", data.form.accountingSubject.calcDict.isExCalc4)}}}',
							href: 'javaScript:;',
							children: '编辑'
						}]
				},{
						...
						children: [{
							...
							children: '：'
								...
								dropdownFooter: {
										...
										style: { width: '100%', borderRadius: '0' },
										children: '新增',
										onClick: "{{function(){$addArchive(data.form.accountingSubject.calcDict.isExCalc5,'exCalc5')}}}"
								},
						},{
							name: 'linkTo',
							component: '::a',
							className: 'app-proof-of-charge-assistitem-openContent',
							onClick: '{{function(){$openContent("userdefinecard", data.form.accountingSubject.calcDict.isExCalc5)}}}',
							href: 'javaScript:;',
							children: '编辑'
						}]
				},{
						...
						children: [{
							...
							children: '：'
								...
								dropdownFooter: {
										...
										style: { width: '100%', borderRadius: '0' },
										children: '新增',
										onClick: "{{function(){$addArchive(data.form.accountingSubject.calcDict.isExCalc6,'exCalc6')}}}"
								},
						},{
							name: 'linkTo',
							component: '::a',
							className: 'app-proof-of-charge-assistitem-openContent',
							onClick: '{{function(){$openContent("userdefinecard", data.form.accountingSubject.calcDict.isExCalc6)}}}',
							href: 'javaScript:;',
							children: '编辑'
						}]
				},{
						...
						children: [{
							...
							children: '：'
								...
								dropdownFooter: {
										...
										style: { width: '100%', borderRadius: '0' },
										children: '新增',
										onClick: "{{function(){$addArchive(data.form.accountingSubject.calcDict.isExCalc7,'exCalc7')}}}"
								},
						},{
							name: 'linkTo',
							component: '::a',
							className: 'app-proof-of-charge-assistitem-openContent',
							onClick: '{{function(){$openContent("userdefinecard", data.form.accountingSubject.calcDict.isExCalc7)}}}',
							href: 'javaScript:;',
							children: '编辑'
						}]
				},{
						...
						children: [{
							...
							children: '：'
								...
								dropdownFooter: {
										...
										style: { width: '100%', borderRadius: '0' },
										children: '新增',
										onClick: "{{function(){$addArchive(data.form.accountingSubject.calcDict.isExCalc8,'exCalc8')}}}"
								},
						},{
							name: 'linkTo',
							component: '::a',
							className: 'app-proof-of-charge-assistitem-openContent',
							onClick: '{{function(){$openContent("userdefinecard", data.form.accountingSubject.calcDict.isExCalc8)}}}',
							href: 'javaScript:;',
							children: '编辑'
						}]
				},{
						...
						children: [{
							...
							children: '：'
								...
								dropdownFooter: {
										...
										style: { width: '100%', borderRadius: '0' },
										children: '新增',
										onClick: "{{function(){$addArchive(data.form.accountingSubject.calcDict.isExCalc9,'exCalc9')}}}"
								},
						},{
							name: 'linkTo',
							component: '::a',
							className: 'app-proof-of-charge-assistitem-openContent',
							onClick: '{{function(){$openContent("userdefinecard", data.form.accountingSubject.calcDict.isExCalc9)}}}',
							href: 'javaScript:;',
							children: '编辑'
						}]
				},{
						...
						children: [{
							...
							children: '：'
								...
								dropdownFooter: {
										...
										style: { width: '100%', borderRadius: '0' },
										children: '新增',
										onClick: "{{function(){$addArchive(data.form.accountingSubject.calcDict.isExCalc10,'exCalc10')}}}"
								},
						},{
							name: 'linkTo',
							component: '::a',
							className: 'app-proof-of-charge-assistitem-openContent',
							onClick: '{{function(){$openContent("userdefinecard", data.form.accountingSubject.calcDict.isExCalc10)}}}',
							href: 'javaScript:;',
							children: '编辑'
						}]
				}]
