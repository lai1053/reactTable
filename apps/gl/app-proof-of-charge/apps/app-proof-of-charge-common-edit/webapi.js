...
export default {
    certificate: {
        ...
        getAutoBalance: () => fetch.post('/v1/gl/doc/getAutoBalance'),
        saveAutoBalance: (option) => fetch.post('/v1/gl/doc/saveAutoBalance', option),
        commonCreate: (option) => fetch.post('/v1/gl/commonDoc/create', option),
    },
    summary: {
