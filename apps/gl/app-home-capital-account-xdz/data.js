export function getMeta() {
	return {
		name: 'root',
		component: 'Layout',
		className: 'edfx-app-home-capital-account-xdz',
		children: [{
			name: 'header',
			component: 'Layout',
			className: 'edfx-app-home-capital-account-xdz-header',
			children: [{
				name: 'left',
				component: '::div',
				className: 'edfx-app-home-capital-account-xdz-header-left',
				children: [{
					name: 'title',
					component: '::span',
					className: 'edfx-app-home-capital-account-xdz-header-left-title',
					children: '资金账户'
				},{
					name: 'selectTime',
					component: '::div',
					className: 'edfx-app-home-capital-account-xdz-header-left-select',
					children: {
						name: 'timeSelect',
						className: '',
            ...
            onChange:'{{function(v,t){let time; time = t.replace("-","."); $setData("data.period",time)}}}'
				...
				name: 'button',
				component: '::span',
				className: 'edfx-app-home-capital-account-xdz-header-right',
				children: {
					name: 'icon',
					component: 'Icon',
					showStyle: 'showy',
			...
			children: {
				...
				name: 'main',
				component: 'Layout',
				className: 'edfx-app-home-capital-account-xdz-main',
					children:[{
					name: 'list',
					component: '::p',
					className: 'edfx-app-home-capital-account-xdz-main-total',
					children: [{
						name: 'span',
						component: '::span',
						children: '合计：'
