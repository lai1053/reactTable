...
class PrintOptionComponent2 extends React.Component {
    ...
    render() {
        const { num, currency, isSampPageContinuePrint ,isOnlyEndNode} = this.state
        return (
            <div className="printOption2">
                        ...
                        <div clssName="printOption2-contaienr-item" style={{ marginBottom: '14px' ,display:'inline',marginRight:'15px'}}>
                            ...
                            <span style={{ paddingRight: '8px', marginBottom: '9px' ,fontSize:'12px',fontFamily:'Microsoft YaHei'}} className="printOption2-label">只{this.props.type}末级</span>
                                ...
                                <div clssName="printOption2-contaienr-item" style={{ marginTop: '14px'}}>
                                    <RadioGroup  onChange={(e) => this.radioChange(e, 'isSampPageContinuePrint')} value={isSampPageContinuePrint}>
                                        <Radio value={false} style={{fontSize:'12px'}}>不同科目分页签{this.props.type=='导出'?'导出':'打印'}</Radio>
                                        <Radio value={true} style={{fontSize:'12px'}}>不同科目同页签连续{this.props.type=='导出'?'导出':'打印'}</Radio>
                                    </RadioGroup>
                                </div> 
                ...
                <div className="printOption2-bottom" style={{ textAlign: 'right', marginTop: '20px', paddingRight: '8px', fontSize:'12px' ,paddingTop:'12px'}}>
                    <Button style={{ marginRight: '8px', padding: '0 15px', height: '32px', fontSize: '12px' }} type='primary' onClick={this.confirm}>{this.props.type}</Button>
