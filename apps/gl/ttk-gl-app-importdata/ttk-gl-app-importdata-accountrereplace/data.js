export function getMeta() {
    return {
        name: 'root',
        component: 'Layout',
        className: 'ttk-gl-app-importdata-accountrereplace',
        // spinning: '{{data.other.loading}}',        
        children: [{
            name: 'search',
            className: 'ttk-gl-app-importdata-accountrereplace-search',
            component: '::div',
            children: {
                name: 'accountSearch',
            ...
            name: 'content',
            className: 'ttk-gl-app-importdata-accountrereplace-content',
            component: '::div',
            children: [{
                name: 'dataGrid',
                component: 'DataGrid',
