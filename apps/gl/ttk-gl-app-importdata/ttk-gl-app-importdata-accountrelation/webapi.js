...
export default {
  importapi: {
    ...
    importDataAsync: () => fetch.post('/v1/ba/basearchive/importDataAsync'),
    importDataStatus: (option) => fetch.post('/v1/ba/basearchive/importDataStatus', option),

    importDataAsyncXdz: () => fetch.post('/v1/edf/basearchive/importDataAsync'),
    importDataStatusXdz: (option) => fetch.post('/v1/edf/basearchive/importDataStatus', option),
    /**
     * 删除
     */
