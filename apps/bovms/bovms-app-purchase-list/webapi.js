...
export default {
    bovms: {
        ...
        // 获取发票种类参数,nsrxz=YBNSRZZS&fplx=jxfp
        ...
        // 获取分页进项数据，
        queryPurchasePageList: option =>
            fetch.post("/v1/biz/bovms/purchase/queryPurchasePageList", option),
        // 编辑时查询进项单张发票单据信息，"id": 1,   --进项单张发票单据id
        getBillsPurchaseInformation: option =>
            fetch.post(
                "/v1/biz/bovms/purchase/getBillsPurchaseInformation",
                option
            ),
        // 编辑时更新进项单张发票单据信息
        updateBillPurchaseInformation: option =>
            fetch.post(
                "/v1/biz/bovms/purchase/updateBillPurchaseInformation",
                option
            ),
        // 进项清单单据批量设置科目数据
        bovmsBillPurchaseBatchsetup: option =>
            fetch.post(
                "/v1/biz/bovms/purchase/bovmsBillPurchaseBatchsetup",
                option
            ),
        ...
        // 进项取票接口
        purchaseTake: option =>
            fetch.post("/v1/biz/bovms/purchase/takePurchaseInvoice", option),
        // 进项取票保存入库
        purchaseTakeSave: option =>
            fetch.post("/v1/biz/bovms/purchase/savePurchaseInvoice", option),
        //进项批量设置保存
        ...
        // 删除进项凭证
        deletePurchaseVoucher: option =>
            fetch.post("/v1/biz/bovms/purchase/deletePurchaseVoucher", option),
        // 销项生成凭证
        createVoucher: option =>
            fetch.post("/v1/biz/bovms/purchase/createVoucher", option),
        // 删除进项发票单据
        deleteBillPurchase: option =>
            fetch.post("/v1/biz/bovms/purchase/deleteBillPurchase", option),
        // 查询科目编号2221对应的子级科目列表
        get2221CodeList: option =>
            fetch.post("/v1/biz/bovms/common/get2221CodeList", option),
        // 进项查票接口
        purchaseChaPiao: option =>
            fetch.post("/v1/biz/bovms/purchase/checkPurchaseTicket", option),
        // 进项入账接口
        purchaseRuZhang: option =>
            fetch.post("/v1/biz/bovms/purchase/savePurchaseTicket", option),
        // 进项查票关闭
        ...
        // 返回当前查询结果的所有BillID
        getAllBillIdPurchase: option =>
            fetch.post("/v1/biz/bovms/purchase/getAllBillIdPurchase", option),
        // 查询进项单张发票单据信息
        getBillPurchaseInformation: option =>
            fetch.post(
                "/v1/biz/bovms/purchase/getBillPurchaseInformation",
                option
            ),
        ...
        automaticBatchMatch: option =>
            fetch.post("/v1/biz/bovms/purchase/automaticBatchMatch", option),
        //进项取票自动匹配
        ...
        automaticSingleMatch: option =>
            fetch.post("/v1/biz/bovms/purchase/automaticSingleMatch", option),
        //获取销取票的智能记忆的数据
