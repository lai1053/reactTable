...
export default class StatementsFilter extends PureComponent {
    ...
    render() {
        ...
        return (
            <div className={"ttk-bovms-app-common-statements-filter " + (className || '')} style={style}>
                <Input
                    className="ttk-bovms-app-common-statements-filter-input"
                    value={inputValue}
...
class StatementsFilterPopover extends PureComponent {
    ...
    getPopupContainer = () => {
        ...
        // return document.querySelector(".ttk-bovms-app-common-statements-filter")
    }
...
class StatementsFilterPopoverContent extends PureComponent {
    ...
    getPopupContainer = () => {
        ...
        //     ".ttk-bovms-app-common-statements-filter .ant-popover-inner-content"
        // )
    }
