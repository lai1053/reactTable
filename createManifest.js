...
console.log('----------start merge js files-------------')
...
const moduleName = ['gl', 'bovms', 'yygl', 'ba','edf','invoices','scm', 'stock']
...
`
    ...
    fs.writeFile(lastPath, content, 'utf8', (err) => {
        if (err) {
            ...
            console.log('base files merge success');
        }
    });
}
