...
function mergeTheme(arr, type) {
    const newArr = [...arr]
    const modules = ['gl', 'bovms', 'yygl', 'ba','edf','invoices','scm', 'stock']
...
module.exports = {
    ...
    entry: {
        ...
        // orangeTheme: orangeStyle.concat(mergeTheme(['./assets/apps/orange.less'], 'orange')),
        // yellowTheme: yellowStyle.concat(mergeTheme(['./assets/apps/yellow.less'], 'yellow')),
