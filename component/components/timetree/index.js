...
class TimetreeComponent extends PureComponent {
    constructor(props) {
        super(props)
                ...
                <div>
                    <span className="arrow">
                        {i % 2 == 0 ?
                            ...
                            <span className="arrow-img arrow-left"></span> : 
                            <span className="arrow-img arrow-right"></span>
                        }
                    </span>
        ...
        return (
            <div className='timetree'>
                <div className='bottom'>
                    ...
                    <span className="bottom-img"></span>
                </div>
                <div className='content'>
                    <div className='rocket slideInUp'>
                        {/*<img className='' src={require(`../../assets/img/rocket.png`)} />*/}
                        <span className="rocket-img"></span>
                    </div>
