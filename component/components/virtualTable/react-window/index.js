        ...
        function(_PureComponent) {
            ...
            _proto._getRangeToRender = function _getRangeToRender() {
                var _this$props5 = this.props,
                    ...
                    isCalcRowSpan = _this$props5.isCalcRowSpan
                var _this$state3 = this.state,
                ...
                return [Math.max(0, startIndex - overscanBackward - isCalcRowSpan?3:0), Math.max(0, Math.min(itemCount - 1, stopIndex + overscanForward)), startIndex, stopIndex];
