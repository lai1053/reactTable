...
switch (argv.original[2]) {
    case '--gl': argName = 'gl'
        break;
    case '--bovms': argName = 'bovms'
        break;
    case '--yygl': argName = 'yygl'
        break;
    case '--ba': argName = 'ba'
        break;
    case '--edf': argName = 'edf'
        break;
    case '--invoices': argName = 'invoices'
        break;
    case '--scm': argName = 'scm'
        break;
    case '--stock': argName = 'stock'
        break;
}
...
/*
if (argName == 'zzssb') {
    if (fs.existsSync(path.resolve(__dirname, `../../tax-sbzs/website/apps/tax-zzssb/index.less`))) {
        entryConfig = {
            [argName]: ["edf-app-loader", "edf-meta-engine", "edf-component", "edf-consts", "edf-utils", "webapi", `../../tax-sbzs/website/apps/tax-zzssb/index.js`],
            // [`${argName}BlackTheme`]: `./apps/${argName}/theme/black.less`,
            [`${argName}BusinessBlueTheme`]: `../../tax-sbzs/website/apps/tax-zzssb/theme/businessBlue.less`,
            [`${argName}OrangeTheme`]: `../../tax-sbzs/website/apps/tax-zzssb/theme/orangeTheme.less`,
            [`${argName}YellowTheme`]: `../../tax-sbzs/website/apps/tax-zzssb/theme/yellowTheme.less`,
            [`${argName}BlueTheme`]: `../../tax-sbzs/website/apps/tax-zzssb/theme/blue.less`,
        }
    } else {
        entryConfig = {
            test: './empty.js'
